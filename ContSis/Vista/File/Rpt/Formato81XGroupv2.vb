...
Public Class Formato81XGroupv2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Vista.Formato81XGroupv2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFormato81XGroupv2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Formato81XGroupv2 = New Formato81XGroupv2()
        rpt.Site = Me.Site
        Return rpt
    End Function

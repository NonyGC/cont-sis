...
Public Class Formato8_1xGroup
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Vista.Formato8_1xGroup.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFormato8_1xGroup
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Formato8_1xGroup = New Formato8_1xGroup()
        rpt.Site = Me.Site
        Return rpt
    End Function
